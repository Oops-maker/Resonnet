...
| [config.md](config.md) | Environment variables; .env loading (project root first); SCENARIO_PRESET, SKILLS_BASE; ANTHROPIC_* vs AI_GENERATION_* |
...
| [skills-generalization.md](skills-generalization.md) | Skills scenario design; experts under `skills/scenarios/topic-lab/`; discussion modes in `skills/moderator_modes/` |
