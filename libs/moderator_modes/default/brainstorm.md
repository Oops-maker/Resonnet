...
- **Divergence** (first half of rounds): Encourage bold ideas, no criticism, "what if" exploration; each expert proposes multiple ideas
- **Organize & evaluate** (middle rounds, may merge): Categorize ideas, identify themes, filter top directions by feasibility and impact
